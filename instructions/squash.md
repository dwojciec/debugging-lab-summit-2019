...
Using *squashctl* on the **Terminal** window or you can use the **Command** **Debug Inventory**
...
~~~shell
$ kubectl port-forward inventory-3-lqvmt :5005 -n coolstoreXX
Forwarding from 127.0.0.1:31002 -> 5005
Forwarding from [::1]:31002 -> 5005
~~~
...
~~~
or use **Command** names **curl inventory**
![Icons]({% image_path curl-inventory.png %}){:width="700px"}
...
~~~
or using the **Command** **Delete attachments** 
![Debug]({% image_path delete-attachments.png %}){:width="900px"}
