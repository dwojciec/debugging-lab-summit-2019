...
image:{% image_path jaeger-query.png %}[Jaeger - Traces View, 800]
...
In CodeReady Workspaces, under the **src/main/java** directory of the **gateway-vertx** project,
...
image:{% image_path spinningtop.jpg %}[Inception - Spinning Top, 300]
