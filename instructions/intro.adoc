...
[link={{ CHE_URL }}/f?url=https://github.com/mcouliba/debugging-workshop]
...
image:{% image_path che-openshift-authorize-access.png %}[Che - OpenShift OAuth Authorize Access,500]
====
